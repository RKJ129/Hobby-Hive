...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        listRecommended.add(new RecommendedModel("ITK Basketball Court", "Basketball", R.drawable.paf1));
        listRecommended.add(new RecommendedModel("ITK Basketball Court", "Basketball", R.drawable.paf2));
        listRecommended.add(new RecommendedModel("ITK Tennis Court", "Tennis", R.drawable.paf3));
        listRecommended.add(new RecommendedModel("St. Louis Basketball Court", "Basketball", R.drawable.paf4));
        listRecommended.add(new RecommendedModel("GBK Lapangan B", "Lapangan", R.drawable.paf5));
        ...
        listLatestUpdates.add(new LatestUpdatesModel("Indonesia Juara SEA Games 2023 Cabang Sepak Bola", "Indonesia meraih prestasi gemilang dalam ajang SEA Games 2023 di cabang sepak bola dengan menyabet gelar juara. Tim nasional sepak bola Indonesia memperlihatkan keunggulan dan ketangguhannya selama turnamen, mengalahkan lawan-lawan tangguh dari negara-negara Asia Tenggara.\n" +
                ...
                "\n" +
                "Indonesia, sebagai tuan rumah SEA Games 2023, telah memberikan pertandingan sepak bola yang tak terlupakan, menarik perhatian dunia, dan mengundang apresiasi dari para penggemar sepak bola di seluruh dunia. Keberhasilan ini menjadi tonggak sejarah bagi sepak bola Indonesia dan menjadi pijakan untuk melangkah lebih jauh dalam kompetisi tingkat internasional.", R.drawable.seagames11));
